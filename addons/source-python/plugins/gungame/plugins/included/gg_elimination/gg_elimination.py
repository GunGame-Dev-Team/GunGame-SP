...
def round_start(game_event):
    ...
    message_manager.chat_message(message='Elimination_RoundInfo')
...
def _respawn_victims(userid):
    ...
    if players:
        message_manager.chat_message(
            index=player.index,
            message='Elimination_Respawning',
